...
#    TestPatternFile  = cms.FileInPath('SLHCUpgradeSimulations/L1CaloTrigger/data/testPattern.txt'),
     TestPatternFile  = cms.FileInPath('SLHCUpgradeSimulations/L1CaloTrigger/data/437.csv'),
)
#----------------------------------------------------------------------------------------------------
...
L1CaloTowerFastjetProducer = cms.EDProducer("L1CaloTowerFastjetProducer",
...
L1TowerJetProducer = cms.EDProducer("L1TowerJetProducer",
    ...
    # UNCOMMENT TO RUN ON TEST PATTERN
#        src = cms.InputTag("L1TestPatternCaloTowerProducer"),
...
#        JetDiameter = cms.uint32(7),
#        JetDiameter = cms.uint32(5),
#        JetDiameter = cms.uint32(3),
#	JetShape    = cms.string("square"), # "circle" or "square"
