...
//     for ( unsigned int i = 0; ((i < lJetWrapper2DVector.size() - 1) && (i < 100)); i++){
// 	if ( lJetWrapper2DVector[i].mJet != NULL ){
// 	  std::cout << i << "\tET = "     << lJetWrapper2DVector[i].mJet->Pt()   << "\tCentrality = " << lJetWrapper2DVector[i].mJet->Centrality() 
// 		    << "\tAsymPhi = "        << lJetWrapper2DVector[i].mJet->AsymPhi()
// 		    << "\tiEta = "        << lJetWrapper2DVector[i].mJet->iEta() << "\tiPhi = "       << lJetWrapper2DVector[i].mJet->iPhi() 
// 		    << "\n\tET = "     << lJetWrapper2DVector[i+1].mJet->Pt()   << "\tCentrality = " << lJetWrapper2DVector[i+1].mJet->Centrality() 
// 		    << "\tAsymPhi = "        << lJetWrapper2DVector[i+1].mJet->AsymPhi()
// 		    << "\tiEta = "        << lJetWrapper2DVector[i+1].mJet->iEta() << "\tiPhi = "       << lJetWrapper2DVector[i+1].mJet->iPhi() 
// 		    << "\n\tJet1 > Jet2 = " << ( lJetWrapper2DVector[i] > lJetWrapper2DVector[i+1] )
// 		    << "\n\n";
